  ...
  const App = () => {
    ...
    return (
      <View style={styles.container}>
        ...
        />
        <Image
          style={styles.questionread}
          source={require("../assets/images/questionread.png")}
        />
        <QuizButton
          ...
          text={"The narrator believes they are outdated and impractical."}
        />
        <QuizButton
          ...
          text={"The narrator has a fondness for them rooted in personal memories."}
        />
        <QuizButton
        ...
        <QuizButton
          ...
          text={"The narrator is indifferent to the type of pencils used."}
        />
        <Submit
          isActive={submit}
          width={381}
        ...
        <Animated.View style={{ ...styles.popupContainer, transform: [{ translateY }] }}>
          {showRight && (
            <View style={styles.popupContent}>
              ...
              />
              <Pressable onPress={() => router.push("levelread2")}>
                <Image
        ...
        <Pressable onPress={() => router.push("expand")}>
                <Image
                  style={styles.expand}
